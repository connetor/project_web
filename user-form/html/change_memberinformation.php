...
<div class="col-md-4 col-xs-12">
        ...
        <div class="user-bg">
            ...
            <div class="overlay-box">
                <div class="user-content">
                    <a href="javascript:void(0)"><img src="../plugins/images/users/genu.jpg" class="thumb-lg img-circle" alt="img">
                    </a>
    ...
    <a class="btn btn-success" onclick="change_datainformation()">บันทึกข้อมูล</a>
    ...
    <div class="white-box">
        ...
        <form class="form-horizontal form-material" id="data_change">
           ...
           <div class="form-group">
			    ...
			    <div class="col-md-12">
			        <input name="fname" type="text" placeholder="<?php echo $data['Fname']; ?>" class="form-control form-control-line"> 
